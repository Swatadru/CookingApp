...
│   ├── routers/                    # Modular API endpoints (Search, Generation, Scoring, etc.)
│   ├── services/                   # ML models, Validators, and Business Logic
│   ├── db/                         # Database models and SQLite/Postgres Engine
│   ├── requirements.txt            # Python dependencies (FastAPI, PyTorch, Transformers)
│   └── (Additional folders for training scripts, datasets, and models)
│
