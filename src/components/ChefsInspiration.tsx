  ...
  return (
    <section className="py-24 bg-surface-container-low">
      <div className="px-margin-mobile md:px-margin-desktop max-w-container-max mx-auto">
        ...
        <div className="relative rounded-[3rem] overflow-hidden group reveal-scale">
          ...
          <div className="absolute bottom-0 left-0 w-full p-12 z-20">
            <div className="max-w-2xl">
              <span className="font-label-sm text-surface bg-secondary px-4 py-1 rounded-full mb-6 inline-block shadow-md">
                {inspirationContent.tag}
              </span>
              <blockquote className="font-quote-it-lg text-display-lg italic text-surface mb-8 leading-tight">
                {inspirationContent.quote}
              </blockquote>
              <div className="flex items-center gap-6">
                <button className="bg-surface text-primary px-8 py-3 rounded-full font-label-sm hover:bg-secondary-fixed hover:scale-105 transition-all duration-300 shadow-md" onClick={() => window.location.href='/library'}>
                  View Full Recipe
                </button>
