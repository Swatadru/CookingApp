  ...
  return (
    <section className="py-24 px-margin-mobile md:px-margin-desktop max-w-container-max mx-auto">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-gutter stagger-children">
        {/* AI Analysis */}
        <TiltCard className="md:col-span-2 glass-card p-10 rounded-[2.5rem] flex flex-col justify-between hover:shadow-xl transition-shadow duration-500 cursor-pointer">
          <div>
            ...
            <h3 className="font-display-lg text-headline-lg text-primary mb-4">Vision AI Prep</h3>
        ...
        {/* Allergen Swapper */}
        <TiltCard className="bg-primary-container p-10 rounded-[2.5rem] text-surface flex flex-col justify-center items-center text-center group cursor-pointer">
          <div className="w-20 h-20 bg-secondary/20 rounded-full flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-500">
            <span className="material-symbols-outlined text-secondary text-4xl">swap_horiz</span>
          </div>
          <h3 className="font-display-lg text-headline-lg mb-4">Allergen Swapper</h3>
          <p className="opacity-80 font-body-md mb-8">
            One click to reinvent any recipe for dairy-free, gluten-free, or vegan lifestyles without losing the soul of the dish.
          </p>
          <a href="/library" className="font-label-sm border-b border-surface/30 pb-1 hover:border-surface transition-all">
            Try it now
          </a>
        </TiltCard>

        {/* Culinary Physics */}
        <TiltCard className="bg-surface-container-highest p-10 rounded-[2.5rem] flex flex-col items-start cursor-pointer">
          <span className="font-label-sm text-secondary font-bold mb-4">NEW MODULE</span>
          <h3 className="font-display-lg text-headline-lg text-primary mb-4">Culinary Physics</h3>
        ...
        {/* Digital Cookbook */}
        <TiltCard className="md:col-span-2 relative rounded-[2.5rem] overflow-hidden shadow-lg min-h-[280px] cursor-pointer">
          <img 
          ...
          <div className="relative z-10 p-12 h-full flex flex-col justify-end text-surface">
            <h3 className="font-display-lg text-display-lg mb-4">The Digital Library</h3>
            ...
            <button className="bg-surface text-primary w-fit px-8 py-3 rounded-full font-label-sm hover:scale-105 transition-all duration-300 shadow-md" onClick={() => window.location.href='/library'}>
              Browse Collection
            </button>
          </div>
        </TiltCard>
